<template>
    <div id="app">
        <div id="header">
            <h1>Todolist</h1><button id="form-hide-show" @click="toggleForm()">Hide/Show Form</button>
            <form @submit.prevent='create()' v-if="formshow">
                ...
                <button type="button" @click="clear()">Clear All Todos</button>
                <button type="button" @click="clearComplete()">Clear Complete Todos</button>
            </form>
        </div>
        <ul id="todos">
